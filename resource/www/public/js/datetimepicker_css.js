...
var WeekHeadColor="#eeeeee";//var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor="#f5f5f5";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="#f5f5f5";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#edf5ff";//var TodayColor="#FFFF33";//Background color of today.
...
var HoverColor="#edf5ff"; //color when mouse move over.
...
function NewCssCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds) {
	...
	if (exDateTime!="")	{ //Parse existing Date String
		...
		/* MJ */
		else if ( Cal.Format.toUpperCase() == "EPOCH" ) {
		    var dsl_date = new Date( parseInt(exDateTime,10) );
	        selDate      = dsl_date;
	        Cal.Hours    = dsl_date.getHours();
            Cal.Minutes  = dsl_date.getMinutes();
            Cal.Seconds  = dsl_date.getSeconds();
...
function RenderCssCal(bNewCal) {
    ...
    if (UseImageFiles)
    {
  		vCalHeader+="<td><img onmousedown='javascript:Cal.DecYear();RenderCssCal();' src='/public/img/cal/cal_fastreverse.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Year scroller (decrease 1 year)
  		vCalHeader+="<td><img onmousedown='javascript:Cal.DecMonth();RenderCssCal();' src='/public/img/cal/cal_reverse.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Month scroller (decrease 1 month)
  		vCalHeader+="<td width='70%' class='calR'><font color='"+YrSelColor+"'>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</font></td>\n"//Month and Year
  		vCalHeader+="<td><img onmousedown='javascript:Cal.IncMonth();RenderCssCal();' src='/public/img/cal/cal_forward.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Month scroller (increase 1 month)
  		vCalHeader+="<td><img onmousedown='javascript:Cal.IncYear();RenderCssCal();' src='/public/img/cal/cal_fastforward.gif' width='13px' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Year scroller (increase 1 year)
  ...
  //******************End Month and Year selector in arrow******************************
	...
	for (i=0;i<7;i++) {
		vCalHeader+="<td bgcolor="+WeekHeadColor+" width='"+CellWidth+"px' class='calTD'>"+WeekDayName[i].substr(0,WeekChar)+"</td>\n";
	}
	...
	if (Cal.ShowTime) 
	{
		...
		{   
            vCalTime+="<td align='center'><table cellspacing='0' cellpadding='0' style='line-height:0pt'><tr><td><img onmousedown='startSpin(\"Hour\", \"plus\");' onmouseup='stopSpin();' src='/public/img/cal/cal_plus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td><img onmousedown='startSpin(\"Hour\", \"minus\");' onmouseup='stopSpin();' src='/public/img/cal/cal_minus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table></td>\n"; 
		}
		...
		if (ShowArrows && UseImageFiles) {
		   vCalTime+="</td>\n<td align='center'><table cellspacing='0' cellpadding='0' style='line-height:0pt'><tr><td><img onmousedown='startSpin(\"Minute\", \"plus\");' onmouseup='stopSpin();' src='/public/img/cal/cal_plus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td><img onmousedown='startSpin(\"Minute\", \"minus\");' onmouseup='stopSpin();' src='/public/img/cal/cal_minus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table>"; 
		}
    ...
    if (UseImageFiles)
    {
       vCalTime+="<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='/public/img/cal/cal_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
    }
    else
    {
    ...
    funcCalback+=" if (Cal.Format.toUpperCase() == 'EPOCH') {"
    funcCalback+=" Cal.m_get_epoch(id,datum);}else{"
    ...
    if(xpos + 16 + CalWidth > bodyWidth) {
        xpos = bodyWidth - CalWidth - 16;
    }
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; backgroundColor = SpanBgColor; zIndex = 100;}
...
function FormatDate(pDate)
{
	...
	else if (this.Format.toUpperCase() =="EPOCH" ) {
		return ("" + Date.UTC( this.Year, this.Month, parseInt(pDate,10), 0, 0, 0 ) );
	}	
	else					
...
Calendar.prototype.m_get_epoch=m_get_epoch;
function m_get_epoch( strp_id, strp_date )
{
    var dsl_date = new Date( parseInt(strp_date,10) );
    var inl_date;
    dsl_date.setHours  ( this.Hours   );
    dsl_date.setMinutes( this.Minutes );
    dsl_date.setSeconds( this.Seconds );
    
    inl_date = dsl_date.getTime();
    document.getElementById(strp_id).value = "" + inl_date;
    try {
        m_epoch_change( strp_id, "" + inl_date );
    } catch(e) {
    }
} // end of m_get_epoch
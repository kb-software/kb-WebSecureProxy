...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.decodingworker=");
    idx += (13 + "decodingworker".length);  // 
  }
  if (idx >= 0) {

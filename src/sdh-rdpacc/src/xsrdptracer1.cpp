...
#define ADSL_WTR_G1 ((struct dsd_wsp_trace_record *) chrl_work1)
       ...
       if (adsp_rdptr1->adsc_hl_clib_1->imc_trace_level & (HL_AUX_WT_DATA1 | HL_AUX_WT_DATA2)) {
         m_dump_gather( chrl_work1,
                        ...
                        adsp_rdptr1->imc_len_trace_input );
       }
...
#define ADSL_WTR_G1 ((struct dsd_wsp_trace_record *) chrl_work1)
       ...
       ADSL_WTR_G1->achc_content = (char *) (ADSL_WTR_G1 + 1);  /* content of text / data */
       ADSL_WTR_G1->imc_length = sprintf( (char *) (ADSL_WTR_G1 + 1),
                                          "server to client virtual channel %04X len-total %d/0X%X ch-flags %02X%02X displacement %d/0X%X %c length %d/0X%X.",
                                          adsp_rdptr1->usc_vch_no,  /* virtual channel no com */
                                          adsp_rdptr1->imc_prot1,  /* virtual channel length uncompressed */
                                          adsp_rdptr1->imc_prot1,  /* virtual channel length uncompressed */
                                          (unsigned char) adsp_rdptr1->chrc_vch_segfl[0],  /* virtual channel segmentation flags */
                                          (unsigned char) adsp_rdptr1->chrc_vch_segfl[1],  /* virtual channel segmentation flags */
                                          adsp_rdptr1->imc_disp_field,  /* displacement of field */
                                          adsp_rdptr1->imc_disp_field,  /* displacement of field */
...
#define ADSL_WTR_G1 ((struct dsd_wsp_trace_record *) chrl_work1)
       ...
       ADSL_WTR_G1->achc_content = (char *) (ADSL_WTR_G1 + 1);  /* content of text / data */
       ADSL_WTR_G1->imc_length = sprintf( (char *) (ADSL_WTR_G1 + 1),
                                          "client to server virtual channel %04X len-total %d/0X%X ch-flags %02X%02X displacement %d/0X%X %c length %d/0X%X.",
                                          adsp_rdptr1->usc_vch_no,  /* virtual channel no com */
                                          adsp_rdptr1->imc_prot1,  /* virtual channel length uncompressed */
                                          adsp_rdptr1->imc_prot1,  /* virtual channel length uncompressed */
                                          (unsigned char) adsp_rdptr1->chrc_vch_segfl[0],  /* virtual channel segmentation flags */
...
#define ADSL_WTR_G1 ((struct dsd_wsp_trace_record *) chrl_work1)
       ...
       ADSL_WTR_G1->achc_content = (char *) (ADSL_WTR_G1 + 1);  /* content of text / data */
       ADSL_WTR_G1->imc_length = sprintf( (char *) (ADSL_WTR_G1 + 1),
                                          "server to client generated virtual channel %04X length %d/0X%X.",
                                          adsp_rdptr1->usc_vch_no,  /* virtual channel no com */
                                          adsp_rdptr1->imc_len_trace_input,  /* length trace-input */
                                          adsp_rdptr1->imc_len_trace_input );  /* length trace-input */
       if (adsp_rdptr1->adsc_hl_clib_1->imc_trace_level & (HL_AUX_WT_DATA1 | HL_AUX_WT_DATA2)) {
...
#define ADSL_WTR_G1 ((struct dsd_wsp_trace_record *) chrl_work1)
       ...
       ADSL_WTR_G1->achc_content = (char *) (ADSL_WTR_G1 + 1);  /* content of text / data */
       ADSL_WTR_G1->imc_length = sprintf( (char *) (ADSL_WTR_G1 + 1),
                                          "client to server generated virtual channel %04X length %d/0X%X.",
                                          adsp_rdptr1->usc_vch_no,  /* virtual channel no com */
                                          adsp_rdptr1->imc_len_trace_input,  /* length trace-input */
                                          adsp_rdptr1->imc_len_trace_input );  /* length trace-input */
       if (adsp_rdptr1->adsc_hl_clib_1->imc_trace_level & (HL_AUX_WT_DATA1 | HL_AUX_WT_DATA2)) {

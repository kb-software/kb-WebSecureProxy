...
#define LEN_NTLM_SEAL_KEY        16         /* length seal key of NTLM      */
...
// int        imc_offset_auth;              /* offset of content NTLMSSP_AUTH */
   ...
   unsigned int umc_message_flags;
   char       *achc_ntlm_client_sign_key;
   char       *achc_ntlm_client_seal_key;
   char       *achc_ntlm_server_sign_key;
   char       *achc_ntlm_server_seal_key;

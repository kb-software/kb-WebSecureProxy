...
enum ied_conf_nodes {
    ...
    ien_cnode_file        ,
    ien_cnode_level       ,
    ien_cnode_reload_path ,
    ien_cnode_domainadmin_group ,
    ien_cnode_rdn         ,
    ien_cnode_autocreate
};
...
private:
    ...
    dsd_ea_config_t  ds_conf;                   // our working copy
    ...
    bool            m_read_domainadmin_group ( DOMNode* ads_cnode );

...
extern "C" struct dsd_target_ineta_1 * m_get_target_ineta( void *ap_ineta, int imp_len_ineta, ied_charset iep_cs_ineta,
   ...
   if (   (iep_cs_ineta != D_CHARSET_IP)
       || (imp_len_ineta >= 0)) {
     iml_rc = m_cpy_vx_vx( chrl_work_ineta, sizeof(chrl_work_ineta), D_CHARSET_IP,

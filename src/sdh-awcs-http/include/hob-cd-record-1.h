...
typedef void ( * amd_cdr_enc )( struct dsd_cdr_ctrl * );
typedef void ( * amd_cdr_dec )( struct dsd_cdr_ctrl * );
...
#else
/* dummy compression                                                   */
extern PTYPE void m_cdr_dummy_enc( struct dsd_cdr_ctrl * );  /* encode = compression */
extern PTYPE void m_cdr_dummy_dec( struct dsd_cdr_ctrl * );  /* decode = decompression */
/* xs-cdr-mppc-4.cpp - RDP4, RDP5, RDP6.0 using little memory          */
extern PTYPE void m_cdr_mppc_4_enc( struct dsd_cdr_ctrl * );  /* encode = compression */
extern PTYPE void m_cdr_mppc_4_dec( struct dsd_cdr_ctrl * );  /* decode = decompression */
/* extended 08.06.13 KB                                                */
extern PTYPE void m_cdr_mppc_5_dec( struct dsd_cdr_ctrl * );  /* decode = decompression */
extern PTYPE void m_cdr_mppc_5_enc(struct dsd_cdr_ctrl *); // encode = compression //added by DD
/* zLib                                                                */
extern PTYPE void m_cdr_zlib_1_enc( struct dsd_cdr_ctrl * );  /* encode = compression */
extern PTYPE void m_cdr_zlib_1_dec( struct dsd_cdr_ctrl * );  /* decode = decompression */
#endif
#endif
#endif

/*_JF_Die Datei C:/Kerberos/auto_analyse_log_TGT/dateien/header/heim_err.h wurde automatisch veraendert! Phase 7*/
...
void initialize_heim_error_table_r( struct dsd_global_and_static * NAME_OF_MAIN_LOC_GLOB_P, struct et_list ** );

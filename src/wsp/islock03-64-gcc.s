...
.text
#use: xbprecomp01 islock03-64.pre islock03-64-gcc.s "xxSET UNIX$GCC=1;"
#     xx = double-percent
#        islock03-64.asm
...
#  KB 21.01.16
        ...
        .equ HEAD_STA,(0*DVOIDSI)
        .equ HEAD_CNT,(1*DVOIDSI)
        .equ TAIL_STA,(2*DVOIDSI)
        .equ TAIL_CNT,(3*DVOIDSI)
        .equ VALUE_XX,(2*DVOIDSI)
#       extern "C" void * m_hl_get_fifo( void ** );

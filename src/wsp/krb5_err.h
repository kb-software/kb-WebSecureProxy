/*_JF_Die Datei C:/Kerberos/auto_analyse_log_TGT/dateien/header/krb5_err.h wurde automatisch veraendert! Phase 7*/
...
void initialize_krb5_error_table_r( struct dsd_global_and_static * NAME_OF_MAIN_LOC_GLOB_P, struct et_list ** );
...
typedef enum krb5_error_number {
    ...
    KRB_AP_ERR_USER_TO_USER_TICKET_REQUIRED = -1765328315,

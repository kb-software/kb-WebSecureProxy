...
/** generate structure INETA for listen with chain field               */
extern "C" struct dsd_chain_listen_ineta_1 * m_get_chain_listen_ineta( void *ap_ineta, int imp_len_ineta, ied_charset iep_cs_ineta ) {
   int        iml_rc;                       /* return code             */
   int        iml_count;                    /* count entries           */
   int        iml_lenmem;                   /* memory needed           */
   char       *achl_ineta;                  /* address of INETA        */
#ifdef HL_UNIX
   char       *achl_service;                /* service name for cheeting */
#endif
   struct addrinfo dsl_addrinfo_w1;
   struct addrinfo *adsl_addrinfo_w2;
   struct addrinfo *adsl_addrinfo_w3;
   struct dsd_chain_listen_ineta_1 *adsl_chain_listen_ineta_1_w1;  /* definition INETA listen with chain field */
   struct dsd_ineta_single_1 *adsl_ineta_s_w1;  /* single INETA listen     */
   char       chrl_work_ineta[ D_MAXLEN_INETA ];
...
// dsl_addrinfo_w1.ai_protocol = IPPROTO_TCP;
   ...
   while (adsl_addrinfo_w3) {
     ...
     switch (adsl_addrinfo_w3->ai_family) {
       case AF_INET:
         m_hl1_printf( "xslnetw1-%05d-T getaddrinfo &adsl_addrinfo_w3->ai_addr=0X%p &(((struct sockaddr_in *) &adsl_addrinfo_w3->ai_addr)->sin_addr.s_addr)=0X%p.",
                       __LINE__,
                       &adsl_addrinfo_w3->ai_addr,
                       &(((struct sockaddr_in *) adsl_addrinfo_w3->ai_addr)->sin_addr.s_addr) );
         m_hl1_printf( "xslnetw1-%05d-T getaddrinfo ai_family AF_INET INETA=%d.%d.%d.%d.",
                       __LINE__,
                       *((unsigned char *) &(((struct sockaddr_in *) adsl_addrinfo_w3->ai_addr)->sin_addr.s_addr) + 0),
                       *((unsigned char *) &(((struct sockaddr_in *) adsl_addrinfo_w3->ai_addr)->sin_addr.s_addr) + 1),
                       *((unsigned char *) &(((struct sockaddr_in *) adsl_addrinfo_w3->ai_addr)->sin_addr.s_addr) + 2),
         ...
         break;
       case AF_INET6:                       /* IPV6                    */
         m_hl1_printf( "xslnetw1-%05d-T getaddrinfo ai_family AF_INET6",
                       __LINE__ );
         break;
       default:
         m_hl1_printf( "xslnetw1-%05d-T getaddrinfo ai_family undefined\n",
                       __LINE__ );
         break;
     }
     adsl_addrinfo_w3 = adsl_addrinfo_w3->ai_next;  /* get next in chain */
...
#endif
   iml_count = 0;                           /* clear count entries     */
   iml_lenmem = sizeof(struct dsd_chain_listen_ineta_1);  /* set memory needed initial */
   adsl_addrinfo_w3 = adsl_addrinfo_w2;     /* get chain of addresses  */
   while (adsl_addrinfo_w3) {
     switch (adsl_addrinfo_w3->ai_family) {
       case AF_INET:                        /* IPV4                    */
   ...
   adsl_chain_listen_ineta_1_w1 = (struct dsd_chain_listen_ineta_1 *) malloc( iml_lenmem );
#define ADSL_LISTEN_INETA_G (&adsl_chain_listen_ineta_1_w1->dsc_listen_ineta_1)
   ADSL_LISTEN_INETA_G->imc_no_ineta = iml_count;  /* number of INETA */
   ADSL_LISTEN_INETA_G->imc_len_mem = iml_lenmem - (sizeof(struct dsd_chain_listen_ineta_1) - sizeof(struct dsd_target_ineta_1));  /* length of memory including this structure */
   adsl_ineta_s_w1 = (struct dsd_ineta_single_1 *) (ADSL_LISTEN_INETA_G + 1);
   adsl_addrinfo_w3 = adsl_addrinfo_w2;     /* get chain of addresses  */
   while (adsl_addrinfo_w3) {
     switch (adsl_addrinfo_w3->ai_family) {
       case AF_INET:                        /* IPV4                    */
   ...
   m_ip_freeaddrinfo( adsl_addrinfo_w2 );   /* free addresses again    */
   return adsl_chain_listen_ineta_1_w1;     /* return structure build  */
} /* end m_get_chain_listen_ineta()                                    */

/** build sum of chain with listen INETAs                              */
extern "C" struct dsd_listen_ineta_1 * m_get_sum_chain_listen_ineta( struct dsd_chain_listen_ineta_1 *adsp_cli1 ) {
   BOOL       bol_pass;                     /* pass thru INETAs        */
   int        iml1, iml2;                   /* working variables       */
   int        iml_count;                    /* count entries           */
   int        iml_lenmem;                   /* memory needed           */
   struct dsd_chain_listen_ineta_1 *adsl_chain_listen_ineta_1_w1;  /* definition INETA listen with chain field */
   struct dsd_chain_listen_ineta_1 *adsl_chain_listen_ineta_1_w2;  /* definition INETA listen with chain field */
   struct dsd_ineta_single_1 *adsl_ineta_1_w1;  /* single INETA        */
   struct dsd_ineta_single_1 *adsl_ineta_1_w2;  /* single INETA        */
   struct dsd_ineta_single_1 *adsl_ineta_1_sum;  /* single INETA       */
   struct dsd_listen_ineta_1 *adsl_listen_ineta_1_w1;  /* definition INETA listen */

   bol_pass = FALSE;                        /* pass thru INETAs        */
   iml_count = 0;                           /* clear count entries     */
   iml_lenmem = sizeof(struct dsd_listen_ineta_1);  /* set memory needed initial */

   p_check_00:                              /* check INETAs            */
   adsl_chain_listen_ineta_1_w1 = adsp_cli1;  /* get input             */

   p_check_20:                              /* check chain element     */
#ifdef TRACEHL1
   m_hl1_printf( "xslnetw1-%05d-T p_check_20: adsl_chain_listen_ineta_1_w1=%p.",
                 __LINE__, adsl_chain_listen_ineta_1_w1 );
#endif
   iml1 = adsl_chain_listen_ineta_1_w1->dsc_listen_ineta_1.imc_no_ineta;  /* number of INETA */
   if (iml1 <= 0) {                         /* number of INETA         */
     goto p_check_68;                       /* end of this chain element */
   }
   adsl_ineta_1_w1 = (struct dsd_ineta_single_1 *) (adsl_chain_listen_ineta_1_w1 + 1);

   p_check_40:                              /* check all previous INETAs */
   adsl_chain_listen_ineta_1_w2 = adsp_cli1;  /* get input             */

   p_check_44:                              /* compare with previous elements */
#ifdef TRACEHL1
   m_hl1_printf( "xslnetw1-%05d-T p_check_44: adsl_chain_listen_ineta_1_w2=%p.",
                 __LINE__, adsl_chain_listen_ineta_1_w2 );
#endif
   iml2 = adsl_chain_listen_ineta_1_w2->dsc_listen_ineta_1.imc_no_ineta;  /* number of INETA */
   if (iml2 <= 0) {                         /* no INETAs               */
     goto p_check_52;                       /* next element to compare */
   }
   adsl_ineta_1_w2 = (struct dsd_ineta_single_1 *) (adsl_chain_listen_ineta_1_w2 + 1);

   p_check_48:                              /* compare INETA           */
#ifdef TRACEHL1
   m_hl1_printf( "xslnetw1-%05d-T p_check_48: _w2=%p _w1=%p iml2=%d iml1=%d.",
                 __LINE__, adsl_ineta_1_w2, adsl_ineta_1_w1, iml2, iml1 );
#endif
   if (adsl_ineta_1_w2 == adsl_ineta_1_w1) {  /* current position      */
     goto p_check_56;                       /* new INETA               */
   }
   if (   (adsl_ineta_1_w2->usc_family == adsl_ineta_1_w1->usc_family)  /* same family */
       && (!memcmp( adsl_ineta_1_w2 + 1, adsl_ineta_1_w1 + 1, adsl_ineta_1_w2->usc_length ))) {  /* INETA double */
#ifdef TRACEHL1
     m_hl1_printf( "xslnetw1-%05d-T p_check_48: found equal adsl_ineta_1_w2->usc_length=%d.",
                   __LINE__, adsl_ineta_1_w2->usc_length );
#endif
     goto p_check_60;                       /* next INETA input        */
   }
   adsl_ineta_1_w2
     = (struct dsd_ineta_single_1 *) ((char *) (adsl_ineta_1_w2 + 1) + adsl_ineta_1_w2->usc_length);
   iml2--;                                  /* index of elements       */
   if (iml2 > 0) {                          /* more chain elements     */
     goto p_check_48;                       /* compare INETA           */
   }

   p_check_52:                              /* next element to compare */
   adsl_chain_listen_ineta_1_w2 = adsl_chain_listen_ineta_1_w2->adsc_next;  /* get next in chain */
   if (adsl_chain_listen_ineta_1_w2 == NULL) {  /* illogic             */
     m_hl1_printf( "xslnetw1-%05d-E m_get_sum_chain_listen_ineta() illogic", __LINE__ );
     adsl_chain_listen_ineta_1_w1 = adsp_cli1;  /* get input           */
     while (adsl_chain_listen_ineta_1_w1) {  /* loop over input        */
       adsl_chain_listen_ineta_1_w2 = adsl_chain_listen_ineta_1_w1;
       adsl_chain_listen_ineta_1_w1 = adsl_chain_listen_ineta_1_w1->adsc_next;  /* get next in chain */
       free( adsl_chain_listen_ineta_1_w2 );  /* free memory           */
     }
     return NULL;
   }
   goto p_check_44;                         /* compare with previous elements */

   p_check_56:                              /* new INETA               */
#ifdef TRACEHL1
   m_hl1_printf( "xslnetw1-%05d-T p_check_56: _w1=%p.",
                 __LINE__, adsl_ineta_1_w1 );
#endif
   if (bol_pass == FALSE) {                 /* pass thru INETAs        */
     iml_count++;                           /* increment count entries */
     iml_lenmem += sizeof(struct dsd_ineta_single_1) + adsl_ineta_1_w1->usc_length;  /* increment memory needed */
   } else {                                 /* pass two - set INETA    */
     memcpy( adsl_ineta_1_sum, adsl_ineta_1_w1, sizeof(struct dsd_ineta_single_1) + adsl_ineta_1_w1->usc_length );
     adsl_ineta_1_sum
       = (struct dsd_ineta_single_1 *) ((char *) (adsl_ineta_1_sum + 1) + adsl_ineta_1_w1->usc_length);
   }

   p_check_60:                              /* next INETA input        */
   adsl_ineta_1_w1
     = (struct dsd_ineta_single_1 *) ((char *) (adsl_ineta_1_w1 + 1) + adsl_ineta_1_w1->usc_length);
   iml1--;                                  /* index of elements       */
   if (iml1 > 0) {                          /* more chain elements     */
     goto p_check_40;                       /* check all previous INETAs */
   }

   p_check_68:                              /* end of this chain element */
   adsl_chain_listen_ineta_1_w1 = adsl_chain_listen_ineta_1_w1->adsc_next;  /* get next in chain */
   if (adsl_chain_listen_ineta_1_w1) {      /* more elements       */
     goto p_check_20;                       /* check chain element     */
   }

// p_check_80:                              /* all chain elements processed */
#ifdef TRACEHL1
   m_hl1_printf( "xslnetw1-%05d-T p_check_80: iml_count=%d.",
                 __LINE__, iml_count );
#endif
   if (bol_pass) {                          /* second pass             */
     adsl_chain_listen_ineta_1_w1 = adsp_cli1;  /* get input           */
     while (adsl_chain_listen_ineta_1_w1) {  /* loop over input        */
       adsl_chain_listen_ineta_1_w2 = adsl_chain_listen_ineta_1_w1;
       adsl_chain_listen_ineta_1_w1 = adsl_chain_listen_ineta_1_w1->adsc_next;  /* get next in chain */
     ...
     return adsl_listen_ineta_1_w1;         /* all done                */
   }
   if (iml_count == 0) {                    /* number of INETA         */
     adsl_chain_listen_ineta_1_w1 = adsp_cli1;  /* get input           */
     while (adsl_chain_listen_ineta_1_w1) {  /* loop over input        */
       adsl_chain_listen_ineta_1_w2 = adsl_chain_listen_ineta_1_w1;
       adsl_chain_listen_ineta_1_w1 = adsl_chain_listen_ineta_1_w1->adsc_next;  /* get next in chain */
     ...
     return NULL;                           /* no INETA found          */
   }
   adsl_listen_ineta_1_w1 = (struct dsd_listen_ineta_1 *) malloc( iml_lenmem );
   adsl_listen_ineta_1_w1->imc_no_ineta = iml_count;  /* number of INETA */
   adsl_listen_ineta_1_w1->imc_len_mem = iml_lenmem;  /* length of memory including this structure */
   adsl_ineta_1_sum = (struct dsd_ineta_single_1 *) (adsl_listen_ineta_1_w1 + 1);
   bol_pass = TRUE;                         /* second pass             */
   goto p_check_00;                         /* check INETAs            */
} /* end m_get_sum_chain_listen_ineta()                                */

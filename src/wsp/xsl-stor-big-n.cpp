...
#ifdef D_CHECK_GAP
extern "C" BOOL m_aux_stor_check_gap( void **aap_anchor );
#endif

#define D_AUX_STOR_SIZE 8192

/* start get storage from system                                       */
extern "C" void m_aux_stor_start( void **aap_anchor ) {
   ...
   *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE)) = NULL;
} /* end m_aux_stor_start()                                            */

extern "C" void * m_aux_stor_alloc( void **aap_anchor, int implen ) {
   ...
   if (implen >= (D_AUX_STOR_SIZE / 2)) {
     ...
     *((void **) achl1) = *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE));
     *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE)) = achl1;
...
#ifdef D_CHECK_GAP
   m_aux_stor_check_gap( aap_anchor );
#endif
   ...
   m_aux_stor_increase( aap_anchor );
   goto pgetaux08;                          /* start from new          */
} /* end m_aux_stor_alloc()                                            */

extern "C" void m_aux_stor_free( void **aap_anchor, void *ap_free ) {
   unsigned int uml_no_ele;                 /* number of elements      */
   unsigned int uml_end;                    /* end of area             */
   char       *achl1, *achl2;               /* working variables       */
   ...
   while (TRUE) {                           /* next auxiliary area     */
     ...
     if (achl1 == NULL) {                   /* no more area            */
       ...
       achl1 = (char *) ((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE));   /* here is anchor          */
...
extern "C" void * m_aux_stor_realloc( void **aap_anchor, void *ap_old, int implen ) {
   int        iml1;                         /* working variable        */
   unsigned int uml1, uml2, uml3;           /* working-variables       */
   int        iml_len;                      /* length entry            */
   ...
   while (TRUE) {                           /* next auxiliary area     */
     ...
     if (achl1 == NULL) {                   /* no more area            */
       /* check if in chain of big storage                             */
       achl_bs_1 = (char *) ((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE));  /* here is anchor       */
       while (TRUE) {                       /* loop over all entries big storage */
   ...
   if (implen >= (D_AUX_STOR_SIZE / 2)) {   /* acquire big element     */
     ...
     *((void **) achl3) = *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE));
     *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE)) = achl3;
...
static void m_aux_stor_increase( void **aap_anchor ) {
   void       *ap_w1;                       /* working-variable        */
...
extern "C" void m_aux_stor_end( void **aap_anchor ) {
   void       *ap_w1;                       /* working-variable        */

   /* free all in chain of big storage                                 */
   while (*((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE))) {
     ap_w1 = *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE));
     *((void **) ((char *) *aap_anchor + D_AUX_STOR_SIZE)) = *((void **) ap_w1);
